...
const Home = () => {
    ...
    return (
        <div className={`home ${!isSignedIn ? "not-signed-in" : ""}`}>
            <Particles
                id="tsparticles"
                init={particlesInit}
            ...
            {isSignedIn && (
                <div className="yc-stats">
                    ...
                    >
                        <p className="number"><CountUp end={providerCount || 0} duration={2} separator="," /></p>
                    ...
                    <div
                        ...
                        style={{ cursor: "pointer" }}
                    >
                        <p className="number"><CountUp end={communityCount || 0} duration={2} /></p>
                        <p className="label">Communities<br />in your Trust Circle</p>
                    </div>
                    <div
                        className="stat clickable-stat"
                        onClick={() => navigate("/trustcircles?tab=myTrust")}
                        style={{ cursor: "pointer" }}
                    >
                        <p className="number"><CountUp end={connectionCount || 0} duration={2} /></p>
                        <p className="label">Followers in Your<br />Trust Circle</p>
                    </div>
                </div>
            )}
