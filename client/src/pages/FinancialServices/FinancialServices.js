 ...
 useEffect(() => {
  ...
  useEffect(() => {
    ...
    const getProviders = async () => {
      ...
      setError(null);
      try {
        const response = await fetch(`${API_URL}/api/financialProviders?user_id=${currentUserId}`);
        if (!response.ok) {
    ...
    <div className="financial-services-container">
      ...
      {!loading && !error && providers.length === 0 && (
        <div className="no-providers-message">
          ...
          <p>
            We couldn't find any financial service recommendations visible to you right now.
          </p>
...
//     (name) => name !== provider.recommended_by_name
//   );
...
//               <div key={idx} className="profile-review">
//                 <div className="review-stars">
//                   {[...Array(5)].map((_, i) => (
//                     <FaStar
//                       key={i}
