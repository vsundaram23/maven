        ...
        const getProviders = async () => {
            ...
            try {
                ...
                const response = await fetch(
                    `${API_URL}/api/financialProviders?${params.toString()}`
                );
                ...
                if (!data.success) {
                    throw new Error(data.message || "Failed to fetch financial providers successfully");
                }
        ...
        if (!isSignedIn && isLoaded) {
            return (
                <div className="error-message full-width-error">
                    Please sign in to view financial service providers.
                </div>
            );
        }
        ...
        <div className="financial-services-container">
            ...
            {!loading && !error && providers.length === 0 && (
                <div className="no-providers-message">
                    ...
                    <h2>No Financial Services Found In Your Network</h2>
                    <p>
                        We couldn't find any financial service recommendations
                        visible to you right now. This might be because:
                    </p>
                    <ul>
                        <li>
                            No public financial recommendations are currently
                            available.
                        </li>
                        <li>
                            None of your direct connections have shared financial
                            recommendations with 'connections' visibility.
                        </li>
                        <li>
                            No financial recommendations have been shared into
...
//         if (!isSignedIn) {
//             setError("Please sign in to view financial service providers.");
//             setLoading(false);
//             setProviders([]);
//             return;
//         }
...
//                     throw new Error(
//                         data.message ||
//                             "Failed to fetch financial providers successfully"
//                     );
//                 }
