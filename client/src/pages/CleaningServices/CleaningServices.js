...
//         setProviders(data);
//         console.log('Fetched cleaning providers:', data);
//       } catch (err) {
//         console.error('Error fetching cleaning providers:', err);
//         setError('Failed to fetch providers');
//       } finally {
//         setLoading(false);
//       }
...
//   if (loading) return <div className="loading-spinner">Loading...</div>;
//   if (error) return <div className="error-message">Error: {error}</div>;
//   if (!providers.length) return <div className="no-data">No cleaning service providers found</div>;
...
//             <div className="card-header">
//               <h2 className="card-title">{provider.business_name}</h2>
//               <span className="badge">Cleaning Services</span>
//             </div>
