                             ...
                             <li key={provider.id} className="provider-card">
                                 <div className="card-header">
                                     ...
                                     <div className="badge-wrapper-with-menu">
                                         ...
                                         <div className="right-actions">
                                                         ...
                                                         <button
                                                             ...
                                                             onClick={() => {
                                                                 navigator.clipboard.writeText(
                                                                     `${window.location.origin}/provider/${provider.id}` // Using window.location.origin for dynamic base URL
                                                                 );
                                             ...
                                             {showLinkCopied && dropdownOpenForId !== provider.id && ( // Only show toast if it's not for the currently open dropdown
                                                 <div className="toast">
                                                     Link copied!
                                                 </div>
                                             )}
                                 ...
                                 <div className="review-summary">
                                     ...
                                     <button
                                         ...
                                         // REMOVED disabled={provider.currentUserLiked}
...
//         if (providerToUpdate.currentUserLiked) {
//             return;
//         }
...
//             items.map(p =>
//                 p.id === providerId
//                     ? { ...p, num_likes: (p.num_likes || 0) + 1, currentUserLiked: true }
//                     : p
//             );
...
//             setRawProviders(finalUpdate(rawProviders));
//             setProviders(finalUpdate(providers));
...
//                                          className={`like-button ${provider.currentUserLiked ? 'liked' : ''}`}
//                                          onClick={() => handleLike(provider.id)}
//                                          disabled={provider.currentUserLiked}
