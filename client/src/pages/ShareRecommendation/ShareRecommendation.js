            ...
            {showSuccessModal && (
                <div className="success-modal-overlay">
                    <div className="success-modal">
                        ...
                        <p className="modal-question">Would you like to submit another one?</p>
                        <div className="success-modal-actions">
                            <button onClick={handleAddAnother} className="btn btn-secondary modal-btn">Yes, Add Another</button>
                            <button onClick={handleGoHome} className="btn btn-primary modal-btn">No</button>
                        </div>
                    </div>
                </div>
            )}
...
// working well (post backend fixes, 5/21)
// import React, { useState, useEffect, useCallback } from "react";
// import { useUser } from "@clerk/clerk-react";
// import { useNavigate } from "react-router-dom";
// import {
